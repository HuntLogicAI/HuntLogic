/**
 * Canonical regulation-rule data for the top 10 hunting states.
 *
 * Shared between the CLI seed script (scripts/seed-regulation-rules.ts) and
 * the protected API route (src/app/api/admin/seed-regulation-rules/route.ts).
 *
 * See docs/regulations-rule-vocabulary.md for ruleType + value JSON shapes.
 */
...
export const REGULATION_RULES_YEAR = 2026;
...
const PA_RULES: RuleSeed[] = [
  ...
  },
  {
    ...
    seasonType: "firearm",
    value: { required: true, color: "fluorescent_orange", min_sq_inches: 250, placement: "head, chest, back combined" },
  },
  {
  ...
  },
  {
    ...
    species: "whitetail",
    value: { required: true, method: "online or phone (HuntFishPA)", deadline_days: 10 },
  },
  {
    ruleType: "non_toxic_shot_required",
    value: { required: true, applies_to: ["waterfowl"], note: "Federal requirement, enforced at state level" },
  },
  {
...
const OH_RULES: RuleSeed[] = [
  ...
  { ruleType: "sunday_hunting_legal", value: { legal: true, restrictions: [] } },
  {
  ...
  { ruleType: "crossbow_during_archery", value: { legal: true, all_hunters: true } },
  {
    ruleType: "orange_minimum",
    seasonType: "firearm",
    value: { required: true, color: "fluorescent_orange", min_sq_inches: 400, placement: "outermost garment" },
  },
  {
    ruleType: "antler_restriction",
    species: "whitetail",
...
const WI_RULES: RuleSeed[] = [
  { ruleType: "weapon_legal", weaponType: "rifle", species: "whitetail", value: { legal: true, restrictions: [] } },
  { ruleType: "sunday_hunting_legal", value: { legal: true, restrictions: [] } },
  {
    ruleType: "baiting_legal",
    species: "whitetail",
  ...
  { ruleType: "crossbow_during_archery", value: { legal: true, all_hunters: true } },
  {
    ruleType: "orange_minimum",
    seasonType: "firearm",
    value: { required: true, color: "blaze_orange_or_fluorescent_pink", pct_visible_above_waist: 50 },
  },
  {
    ruleType: "mandatory_harvest_report",
    species: "whitetail",
...
const IA_RULES: RuleSeed[] = [
  ...
  { ruleType: "sunday_hunting_legal", value: { legal: true, restrictions: [] } },
  { ruleType: "baiting_legal", species: "whitetail", value: { legal: false, reason: "Iowa prohibits hunting deer over bait" } },
  {
    ruleType: "crossbow_during_archery",
    value: {
      legal: true,
...
const TX_RULES: RuleSeed[] = [
  ...
  },
  {
    ...
    species: "whitetail",
    weaponType: "rifle",
    value: { min_caliber: null, note: "TX has no statewide caliber minimum for deer. Common ethical practice is .243 or larger." },
  },
  {
...
const CO_RULES: RuleSeed[] = [
  { ruleType: "weapon_legal", weaponType: "rifle", species: "elk", value: { legal: true, restrictions: [] } },
  {
    ruleType: "caliber_min",
    species: "elk",
    weaponType: "rifle",
  ...
  { ruleType: "sunday_hunting_legal", value: { legal: true, restrictions: [] } },
  { ruleType: "baiting_legal", species: "elk", value: { legal: false, reason: "Baiting prohibited for big game in CO" } },
  { ruleType: "baiting_legal", species: "whitetail", value: { legal: false } },
  {
    ruleType: "crossbow_during_archery",
    value: {
      legal: false,
...
const NV_RULES: RuleSeed[] = [
  ...
  {
    ruleType: "orange_minimum",
    value: { required: false, note: "Not required statewide. Some specific units may have requirements; verify by unit." },
  },
  {
    ruleType: "nonresident_cap_pct",
    species: "elk",
...
export const STATE_REGULATION_RULES: Record<string, RuleSeed[]> = {
  PA: PA_RULES,
  OH: OH_RULES,
  WI: WI_RULES,
  MI: MI_RULES,
